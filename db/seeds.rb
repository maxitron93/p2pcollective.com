...
# purposes = ([
#   {
#     loan_category_id: LoanCategory.all[0].id,
...
#   },
#   {
#     loan_category_id: LoanCategory.all[1].id,
...
#   },
#   {
#     loan_category_id: LoanCategory.all[2].id,
...
#   },
#   {
#     loan_category_id: LoanCategory.all[3].id,
...
#   },
#   {
#     loan_category_id: LoanCategory.all[4].id,
...
#   },
#   {
#     loan_category_id: LoanCategory.all[5].id,
...
#   },
#   {
#     loan_category_id: LoanCategory.all[6].id,
...
#   },
#   {
#     loan_category_id: LoanCategory.all[7].id,
...
#   employment_type_id = rand(EmploymentType.all[0].id..EmploymentType.all[5].id)
...
charts = [
  {
    ...
    row_spacing: 6,
    rows: [
      {type: "task", title: "Task one", xStart: 0, xWidth: 282, color: "rgb(242, 153, 74)"},
      {type: "task", title: "Task two", xStart: 162, xWidth: 324, color: "rgb(242, 153, 74)"},
      {type: "task", title: "Task three", xStart: 242, xWidth: 244, color: "rgb(242, 153, 74)"},
      {type: "deadline", title: "Deadline one", xStart: 466, color: "rgb(229, 74, 74)"},
      {type: "task", title: "Task four", xStart: 486, xWidth: 200, color: "rgb(63, 169, 229)"},
      {type: "task", title: "Task five", xStart: 648, xWidth: 484, color: "rgb(63, 169, 229)"},
      {type: "task", title: "Task six", xStart: 930, xWidth: 202, color: "rgb(63, 169, 229)"},
      {type: "deadline", title: "Deadline two", xStart: 1112, color: "rgb(229, 74, 74)"}
    ]
  }
]

Chart.create!(charts) { |chart| puts "'#{chart.chart}' created" }